...
public class ResourceUtil {
    ...
    private static final ResourceBundle redisBundle = java.util.ResourceBundle.getBundle("redis");
     ...
     * @return
     */
    public static final String getRedisConfig(String key) {
    ...
    public static final WeixinAccountEntity getWeiXinAccount() {
        ...
        if (session.getAttribute(WeiXinConstants.WEIXIN_ACCOUNT) != null) {
            WeixinAccountEntity WeixinAccountEntity =
                (weixin.guanjia.account.entity.WeixinAccountEntity)session.getAttribute(WeiXinConstants.WEIXIN_ACCOUNT);
